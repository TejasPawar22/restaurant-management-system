...
<body>
    ...
    <section id="home">
        ...
        <p class="p">Hotel rooms have everything you need for a pleasant stay large comfortable beds covered with special bedspreads that get made by themselves, and bathrooms that are clean and shiny.</p><br>
        <p class="p">Hotel rooms are known for having terraces with views that are perfect for enjoyment views that are perfect for enjoyment.</p>
    ...
    <section id="rooms-right">
        <div class="paras">
          ...
          <p class="sectionsubTag font">We have the best services provider in Room Management. with 24 hours room services and 24 hours check-out. We provide world class services in very low cost. i.e. 5000 Rs.</p>
          <p class="price">Price per room : 5000 Rs/-</p>
    ...
    <section id="rooms-left">
        <div class="paras">
          ...
          <p class="sectionsubTag font">We have the best services provider in Room Management. with 24 hours room services and 24 hours check-out. We provide world class services in very low cost. i.e. 2000 Rs.</p>
          <p class="price">Price per room : 2000 Rs/-</p>
          <a href="room.php"><button class="price-btn">Book A Room</button></a>
          </div>
          <div class="thumbnail">
    ...
    <section id="rooms-right">
        <div class="paras">
          ...
          <p class="sectionsubTag font">We have the best services provider in Room Management. with 24 hours room services and 24 hours check-out. We provide world class services in very low cost. i.e. 1000 Rs.</p>
          <p class="price">Price per room : 1000 Rs/-</p>
            <a href="room.php"><button class="price-btn">Book A Room</button></a>
          </div>
          <div class="thumbnail">
    ...
    <section id="footer" class="section footer">
        <div class="container">
            <div class="footer-container">
                ...
                <div class="footer-center">
                    <h3>CONTACT INFO</h3>
                    <p>Athrav Joshi<br><br>+91 9284627183 <br></p>
                    <p><a href="https://wa.link/7xr7uh">Whatsapp Me</a></p>
                </div>
                <div class="footer-center">
