...
<body>
    ...
    <div class="imgg">
    <img src="../img/deluxroom.jpg" alt="delux ac">
    <img src="../img/deluxroom.jpg" alt="delux ac">
    </div>
...
<div class="delux-insert">
    ...
    <form action="adelux.php" method="post">
             <table>
                ...
                <tr>
                    ...
                    <td><input type="hidden" name="type" placeholder="Enter Room Type " title="Room Type" value="deluxAC"> </td>
                </tr>
                <tr>
                    <td>Room Price</td>
    ...
    <?php if (isset($_POST['submit'])) {
        ...
        $selectroom = "SELECT roomno FROM deluxacroom where roomno='$rno'";
        $run = mysqli_query($sql, $selectroom);
        $count = mysqli_num_rows($run);
        if ($count > 0) {
            $update = "update deluxacroom set price='$price' where roomno='$rno'";
            $run = mysqli_query($sql, $update);
            echo "<script>
