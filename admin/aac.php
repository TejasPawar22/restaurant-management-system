...
<div class="delux-insert">
    <form action="aac.php" method="post">
             <table>
                ...
                <tr>
                    ...
                    <td><input type="hidden" name="type" placeholder="Enter Room Type " title="Room Type" value="AC"> </td>
                </tr>
                <tr>
                    <td>Room Price</td>
    ...
    <?php if (isset($_POST['submit'])) {
        ...
        $selectroom = "SELECT roomno FROM acroom where roomno='$rno'";
        $run = mysqli_query($sql, $selectroom);
        $count = mysqli_num_rows($run);
        if ($count > 0) {
            $update = "update acroom set price='$price' where roomno='$rno'";
